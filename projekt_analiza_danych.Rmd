...
# 2. Obliczanie statystyk dla zmiennych ciągłych (GPA)
stats_gpa <- dane_tabs %>%
  group_by(Stypendium) %>%
  summarise(m = round(mean(GPA, na.rm = TRUE), 2),
            sd = round(sd(GPA, na.rm = TRUE), 2))

# 3. Obliczanie statystyk dla zmiennych kategorycznych
get_cat_stats <- function(var_name) {
  dane_tabs %>%
    group_by(Stypendium, val = !!sym(var_name)) %>%
...
p_stats <- get_cat_stats("sex")
n_stats <- get_cat_stats("studying")
i_stats <- get_cat_stats("partying")

# 4. RĘCZNE BUDOWANIE STRUKTURY TABELI
# Kolumny: Cecha | Mean/N | SD/% | Mean/N  | SD/% 

create_row <- function(name, n1, s1, n2, s2) {
  data.frame(Cecha = name, N1 = as.character(n1), S1 = as.character(s1), 
             N2 = as.character(n2), S2 = as.character(s2), stringsAsFactors = FALSE)
}

final_df <- rbind(
  create_row("Liczba obserwacji (N)", table(dane_tabs$Stypendium)[1], "", table(dane_tabs$Stypendium)[2], ""),
  create_row("Średnia ocen (GPA)", stats_gpa$m[1], stats_gpa$sd[1], stats_gpa$m[2], stats_gpa$sd[2]),
  
  create_row("PŁEĆ", "", "", "", ""),
  create_row("  Kobieta", p_stats$n[p_stats$val=="Kobieta" & p_stats$Stypendium=="Niestypendyści"], p_stats$pct[p_stats$val=="Kobieta" & p_stats$Stypendium=="Niestypendyści"], p_stats$n[p_stats$val=="Kobieta" & p_stats$Stypendium=="Stypendyści"], p_stats$pct[p_stats$val=="Kobieta" & p_stats$Stypendium=="Stypendyści"]),
  create_row("  Mężczyzna", p_stats$n[p_stats$val=="Mężczyzna" & p_stats$Stypendium=="Niestypendyści"], p_stats$pct[p_stats$val=="Mężczyzna" & p_stats$Stypendium=="Niestypendyści"], p_stats$n[p_stats$val=="Mężczyzna" & p_stats$Stypendium=="Stypendyści"], p_stats$pct[p_stats$val=="Mężczyzna" & p_stats$Stypendium=="Stypendyści"]),
  
  create_row("CZAS NAUKI", "", "", "", ""),
  create_row("  0 h", n_stats$n[n_stats$val=="0" & n_stats$Stypendium=="Niestypendyści"], n_stats$pct[n_stats$val=="0" & n_stats$Stypendium=="Niestypendyści"], "0", "0"),
  create_row("  1-3 h", n_stats$n[n_stats$val=="1-3" & n_stats$Stypendium=="Niestypendyści"], n_stats$pct[n_stats$val=="1-3" & n_stats$Stypendium=="Niestypendyści"], n_stats$n[n_stats$val=="1-3" & n_stats$Stypendium=="Stypendyści"], n_stats$pct[n_stats$val=="1-3" & n_stats$Stypendium=="Stypendyści"]),
  create_row("  3-5 h", n_stats$n[n_stats$val=="3-5" & n_stats$Stypendium=="Niestypendyści"], n_stats$pct[n_stats$val=="3-5" & n_stats$Stypendium=="Niestypendyści"], n_stats$n[n_stats$val=="3-5" & n_stats$Stypendium=="Stypendyści"], n_stats$pct[n_stats$val=="3-5" & n_stats$Stypendium=="Stypendyści"]),
  create_row("  5-8 h", n_stats$n[n_stats$val=="5-8" & n_stats$Stypendium=="Niestypendyści"], n_stats$pct[n_stats$val=="5-8" & n_stats$Stypendium=="Niestypendyści"], n_stats$n[n_stats$val=="5-8" & n_stats$Stypendium=="Stypendyści"], n_stats$pct[n_stats$val=="5-8" & n_stats$Stypendium=="Stypendyści"]),
  create_row("  8+ h", n_stats$n[n_stats$val=="8+" & n_stats$Stypendium=="Niestypendyści"], n_stats$pct[n_stats$val=="8+" & n_stats$Stypendium=="Niestypendyści"], n_stats$n[n_stats$val=="8+" & n_stats$Stypendium=="Stypendyści"], n_stats$pct[n_stats$val=="8+" & n_stats$Stypendium=="Stypendyści"]),
  
  create_row("IMPREZOWANIE", "", "", "", ""),
  create_row("  0 (Abstynencja)", i_stats$n[i_stats$val=="0" & i_stats$Stypendium=="Niestypendyści"], i_stats$pct[i_stats$val=="0" & i_stats$Stypendium=="Niestypendyści"], i_stats$n[i_stats$val=="0" & i_stats$Stypendium=="Stypendyści"], i_stats$pct[i_stats$val=="0" & i_stats$Stypendium=="Stypendyści"]),
  create_row("  1-2 razy", i_stats$n[i_stats$val=="1" & i_stats$Stypendium=="Niestypendyści"], i_stats$pct[i_stats$val=="1" & i_stats$Stypendium=="Niestypendyści"], i_stats$n[i_stats$val=="1" & i_stats$Stypendium=="Stypendyści"], i_stats$pct[i_stats$val=="1" & i_stats$Stypendium=="Stypendyści"]),
  create_row("  Tylko weekendy", i_stats$n[i_stats$val=="Only weekends" & i_stats$Stypendium=="Niestypendyści"], i_stats$pct[i_stats$val=="Only weekends" & i_stats$Stypendium=="Niestypendyści"], i_stats$n[i_stats$val=="Only weekends" & i_stats$Stypendium=="Stypendyści"], i_stats$pct[i_stats$val=="Only weekends" & i_stats$Stypendium=="Stypendyści"]),
  create_row("  3+ razy", i_stats$n[i_stats$val %in% c("3", "4+") & i_stats$Stypendium=="Niestypendyści"] %>% sum(), i_stats$pct[i_stats$val %in% c("3", "4+") & i_stats$Stypendium=="Niestypendyści"] %>% sum(), i_stats$n[i_stats$val %in% c("3", "4+") & i_stats$Stypendium=="Stypendyści"] %>% sum(), i_stats$pct[i_stats$val %in% c("3", "4+") & i_stats$Stypendium=="Stypendyści"] %>% sum())
)
